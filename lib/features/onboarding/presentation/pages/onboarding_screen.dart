                ...
                Column(
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                        CustomPaint(
                          size: const Size(186, 186), // Matches w-48 h-48 (48 * 4 = 192px)
                    ...
                    Text(
                      ...
                      style: GoogleFonts.inter(
                        ...
                        color: theme.colorScheme.shadow, // Matches text-muted (#7A8C99)
...
class DecorativeCirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 72; i++) {
      final angle = (i * 5) * (3.141592653589793 / 180); // Convert degrees to radians
      canvas.save();
